# Calculate gradual change statistics for every model
library(pbapply)
...
EvaluateGradualChange = function(ChangeFile)
{
    ...
    Changes = Changes[Changes$Change>0 & Changes$Change<100, ]

    #hist(Changes$Change[Changes$Change>0 & Changes$Change<100], breaks="Scott")


    ChangeOutFile = sub("-change_val_scaled\\.csv$", "-gradual_change_stats.csv", ChangeFile)
