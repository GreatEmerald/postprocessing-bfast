...
InputPattern = glob2rx("*-trend-stats-yearly.csv")
...
ModelMap = c(`dynamicworld/dynamicworld-trend-stats-yearly.csv` = "Dynamic World",
             `dynamicworld-loess/predictions-trend-stats-yearly.csv` = "Dynamic World + LOESS",
             #`dynamicworld-loess-s05/predictions-trend-stats-yearly.csv` = "Dynamic World + LOESS (a=0.5)",
             #`dynamicworld/dynamicworld-m10-trend-stats-yearly.csv` = "Dynamic World (10% threshold)",
             #`dynamicworld-bfl/predictions-trend-stats-yearly.csv` = "Dynamic World + BFL (h=72)",
             #`dynamicworld-bfl-h016/predictions-trend-stats-yearly.csv` = "Dynamic World + BFL (h=0.16)",
             #`dynamicworld-bfl-harmon1-h016/predictions-trend-stats-yearly.csv` = "Dynamic World + BFL (h=0.16, order=1)",
             #`dynamicworld-bfl-harmon3-h016/predictions-trend-stats-yearly.csv` = "Dynamic World + BFL (h=0.16, order=3)",
             #`dynamicworld-bfl-m30-harmon2-h016/predictions-trend-stats-yearly.csv` = "Dynamic World + BFL (h=0.16, mag>30)",
             `dynamicworld-bfl-m30-trend-h016/predictions-trend-stats-yearly.csv` = "Dynamic World + BFAST Lite",
             `summer/mean_predictions-trend-stats-yearly.csv` = "Random Forest regression",
             #`summer/mean_predictions_scaled-trend-stats-yearly.csv` = "Random Forest mean vote (scaled)",
             #`summer/median_predictions-trend-stats-yearly.csv` = "Random Forest median vote",
             `summer-loess/mean_predictions-trend-stats-yearly.csv` = "Random Forest + LOESS",
             #`summer-bfl-m30-harmon2-scaled-h12-fb/mean_predictions-trend-stats-yearly.csv` = "RF mean + BFL (h=12)",
             #`summer-bfl-m30-harmon2-scaled-h016-fb/mean-predictions-trend-stats-yearly.csv` = "RF mean + BFL (h=0.16)",
             #`summer-bfl-m30-harmon2-scaled-h12-fb/median_predictions-trend-stats-yearly.csv` = "RF median + BFL (h=12)",
             `summer-bfl-m30-trend-scaled-h016-fb/mean-predictions-trend-stats-yearly.csv` = "Random Forest + BFAST Lite",
             `summer-bfbaseline-m02-harmon-scaled/mean_predictions-trend-stats-yearly.csv` = "RF + NDVI-only BFAST Lite",
             `summer-beast/mean-predictions-trend-stats-yearly.csv` = "Random Forest + BEAST"
             #`summer-bfbaseline-m02-harmon-scaled/median_predictions-trend-stats-yearly.csv` = "RF median + NDVI BFL"
             )

VisualiseModelStats(InputDir, InputPattern, ModelMap=ModelMap, main="", VariablePattern=glob2rx("ChangeTrend.*"), Statistics=c("MAE", "ME"), filename="../../output/2023-06-22-trend-stats.pdf") # Trends (aggregated)
...
VisualiseModelStats(InputDir, InputPattern, ModelMap=ModelMap, main="", VariablePattern=glob2rx("ChangeRMSD.*"), Statistics=c("MAE", "ME"), filename="../../output/2023-06-22-variance-stats.png") # Variance (RMSD, aggregated)
